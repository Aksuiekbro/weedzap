...
python export.py --weights custom-models/tiny_model_680.ckpt --grid --end2end --simplify --topk-all 100 --iou-thres 0.65 --conf-thres 0.35 --img-size 640
```
...
# Try direct export
yolo export model=custom-models/tiny_model_680.ckpt format=onnx imgsz=640
```
